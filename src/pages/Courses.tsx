      ...
      <div className="max-w-[375px] mx-auto mt-10">
        ...
        <div className="flex items-center justify-end">
                  <button className="text-white rounded-full w-10 h-10 flex items-center justify-center hover:text-gray-100 transition-colors duration-200 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="w-5 h-5 lucide lucide-calculator-icon lucide-calculator"><rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/></svg>
                  </button>
                </div>
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="bg-white rounded-full w-6 h-6 flex items-center justify-center hover:bg-gray-100 transition-colors duration-200 cursor-pointer">
              <svg className="w-5 h-5 text-[#2E2E69]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
              </svg>
            </button>
          ...
          <div className="grid grid-cols-2 space-y-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-white text-sm">LISE VIGNAUD</span>
            </div>
            <div className="flex items-center space-x-3">
              <img src={studentImg} alt="Profile" className="w-8 h-8 rounded-full" />
              <span className="text-white text-sm">JEAN MARCQUE</span>
            </div>
            <div className="flex items-center space-x-3">
              <img src={studentImg} alt="Profile" className="w-8 h-8 rounded-full" />
              <span className="text-white text-sm">AARON SEVIER</span>
            </div>
            <div className="flex items-center space-x-3">
              <img src={studentImg} alt="Profile" className="w-8 h-8 rounded-full" />
              <span className="text-white text-sm">YASIM NODUR</span>
            </div>
            <div className="flex items-center space-x-3">
              <img src={studentImg} alt="Profile" className="w-8 h-8 rounded-full" />
              <span className="text-white text-sm">YASIM NODUR</span>
